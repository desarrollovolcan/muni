            ...
            <div class="col-md-auto">
                <div class="card auth-box-form border-0 mb-0">
                    ...
                    <div class="card-body min-vh-100 d-flex flex-column justify-content-center">
                        ...
                        <div class="mt-auto">
                            <p class="text-muted text-center auth-sub-text mx-auto">Crea tu cuenta con los datos del funcionario municipal.</p>
                            ...
                            <form class="mt-4" method="post" action="auth-sign-up.php">
                                ...
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-primary fw-bold py-2">Crear cuenta</button>
                                </div>
                            </form>
                        </div>

                        <p class="text-muted text-center mt-4 mb-0">
                            ¿Ya tienes cuenta? <a href="auth-2-sign-in.php" class="text-decoration-underline link-offset-3 fw-semibold">Iniciar sesión</a>
                        </p>
