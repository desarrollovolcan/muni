                                ...
                                <form id="municipalidad-form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" id="muni-nombre" name="nombre" class="form-control" value="<?php echo htmlspecialchars($municipalidad['nombre'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="file" id="muni-logo" name="logo" class="form-control">
                                            <small class="text-muted">PNG, JPG o SVG. Se usará como logo del proyecto.</small>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">Vista previa</label>
                                            <div class="border rounded p-3 bg-light text-center">
                                                <img src="<?php echo htmlspecialchars($municipalidad['logo_path'] ?? 'assets/images/logo.png', ENT_QUOTES, 'UTF-8'); ?>" alt="Logo municipalidad" style="max-height: 80px;">
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
